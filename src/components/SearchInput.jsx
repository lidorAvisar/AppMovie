...
export default function SearchInput() {
    ...
    return (
        <div>
            <div className="input_search d-md-none align-items-center justify-content-center z-3 ">
                <div className="input_search d-flex justify-content-center   align-items-center col-md-11 col-lg-12" style={{ marginBottom: '5px' }}>
                    <button onClick={(e)=>{navigate(`/search/${inputData.current.value}`)}} style={{ width: '50px', height: '39px', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '25px 0px 0px 25px', border: 'none' }} className=" col-2 btn btn-danger">
