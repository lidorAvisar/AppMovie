      ...
      <div  id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel">
        <div className="carusel-img carousel-inner">
          <div className="carousel-item active" data-bs-interval="5100" >
            <img style={{ width: '100%', height: '100%' }} src="https://images6.alphacoders.com/103/1030419.jpg" className="d-block" alt="..." />
          </div>
          <div className="carousel-item" data-bs-interval="5100">
            <img style={{ width: '100%', height: '100%' }} src="https://images8.alphacoders.com/100/1003220.png" className="d-block" alt="..." />
          </div>
          <div className="carousel-item" data-bs-interval="5100">
            <img style={{ width: '100%', height: '100%' }} src="https://images5.alphacoders.com/336/336484.jpg" className="d-block" alt="..." />
          </div>
        </div>
